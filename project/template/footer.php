            ...
            <div class="footer-w3lagile-innerr">
                    ...
                    <div class="row  footer-v2grids w3-agileits">
                        ...
                        <div class="col-lg-2 col-sm-6 footer-v2grid">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#">Pembatalan & Pengembalian</a>
                                </li>
                                <li>
                ...
                <div class="footer-bottomv2 py-5">
                    <div class="container">
                        ...
                        <h3 class="text-center follow">Ikuti kami</h3>
            ...
            <div class="container-fluid py-5 footer-copy_w3ls">
                <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="cpy-right align-self-center">
                        ...
                        <p>© 2018 Arch Guitar | Design by
                            <a href="http://w3layouts.com" class="text-secondary"> inuy dan yay </a>
                        </p>
                    </div>
                </div>
            </div>
