          ...
          <div class="animated fadeIn">
            <div class="row">
                ...
                ?>
                      ...
                      <a href="<?php echo $admin_url; ?>module/kategori/hapus.php?id_kategori=<?php echo $kat['id_kategori_produk']; ?>">
                    <button  class="btn btn-pill btn-danger" type="button">
                      <i class="icon-trash"></i> Hapus</button></a>
                      <a href="<?php echo $admin_url; ?>admin.php?module=feditkat&id_kategori=<?php echo $kat['id_kategori_produk']; ?>">
